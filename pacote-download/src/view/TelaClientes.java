...
public class TelaClientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelaClientes.setModel(exibirTabela());
        scroll.setViewportView(tabelaClientes);

        btnCadastrarClientes.setBackground(new java.awt.Color(255, 80, 49));
        btnCadastrarClientes.setForeground(new java.awt.Color(255, 255, 255));
        btnCadastrarClientes.setText("Cadastrar");
        btnCadastrarClientes.setBorder(null);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(btnCadastrarClientes, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnCadastrarClientes, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
...
this.dispose();    }//GEN-LAST:event_btnSairActionPerformed
    ...
    private void btnCadastrarClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarClientesActionPerformed
        TelaCadastroClientes tCc = new TelaCadastroClientes();
        tCc.setVisible(true);
        this.dispose();
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        int id = getPosicao();
        int resposta = JOptionPane.showConfirmDialog(null, "Realmente deseja excluir este cliente?");
        if (resposta == 0) {
    ...
    private DefaultTableModel exibirTabela() {
        String[] coluna = {"Id", "Nome", "Data de nascimento", "CPF"};
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            String[] linha = {
                ...
                cliente.getNome(),
                cliente.converterParaJava(cliente.getData_nascimento()),
                cliente.getCpf()
            };
            tabela.addRow(linha);
